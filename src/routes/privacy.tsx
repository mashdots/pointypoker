    ...
    <Wrapper>
      <Container>
        ...
        <Section>
          ...
          <p>
            Firebase is owned by Google. You can read their privacy policy at <a href="https://policies.google.com/privacy" target='_blank'
              rel="noreferrer">https://policies.google.com/privacy</a> and Firebase&apos;s privacy documentation at <a href="https://firebase.google.com/support/privacy/" target='_blank'
              rel="noreferrer">https://firebase.google.com/support/privacy/</a>.
          </p>
        </Section>
        <Section>
          <h3>
